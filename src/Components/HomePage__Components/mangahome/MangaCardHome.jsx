...
const MangaCard = ({ manga }) => {
  ...
  return (
    <>
      <div className='MangaHome__CatalogCard' onClick={() => navigate(`/manga/${manga.id}`)}>
        <img src={manga.image} alt="" className='MangaHome__Catalog-cardImg' />
